  ...
  return (
        <section>
            <div className="max-w-[1170px] px-5 mx-auto">
                ...
                {
                    !loading && !error && <div className='grid grid-cols-3 gap-[30px] lg:gap-[50px]'>
                            ...
                            {data.isApproved === 'pending' && (<div className='flex p-4 mb-4 text-yellow-800
                                ...
                                '>
                                    ...
                                    <div className='ml-3 text-sm font-medium'>
                                        To get approval pls complete your profile. We&apos;ll 
                                        review manually and approve within 4 days. 
                                    </div>
                                </div>
                            )}    
                                        ...
                                        <div className="flex items-center mb-10 gap-4">
                                            ...
                                            <div>
                                                <span className='bg-[#CCF0F3] text-irisBlueColor 
                                                    py-1 px-4 lg:py-2 lg:px-6 text-[12px] leading-4 lg:text-[16px] 
